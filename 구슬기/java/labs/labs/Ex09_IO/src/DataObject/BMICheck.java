...
public class BMICheck {
	...
	private void save() { //실제로 저장이 되는 메서드. 맵을 파일에 객체형태로 쓰는 것이다. 
		...
		try{
			...
			oos.writeObject(map);// map 안에는 (1,new BMI) (2,new BMI)(3,new BMI) 가 되어있다.
	...
	private void delete() { //map에서 지우는 것
