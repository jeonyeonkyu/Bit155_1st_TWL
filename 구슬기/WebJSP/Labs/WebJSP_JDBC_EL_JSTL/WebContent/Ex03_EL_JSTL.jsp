...
<!-- 객체를 직접 쓰지는 못하는데 JSTL 을 사용해서 변수에 넣어주면 그때부터 사용가능하다. -->
...
$m.empno 는 내부적으로 getter 함수 호출하는 거라서 만들어 놓지 않은 상태라면 오류난다.  
...
EL JSTL 은 값을 넣는것보다는 읽어오는게 주 목적  <br>
hp 객체 : ${vhp}<br>
