...
public class BoardService {
	...
	//서비스 요청(글쓰기)
		...
		public int replyDelete(String no, String pwd) throws NamingException {
			return new BoardDao().replyDelete(no, pwd); //게시물 번호와 비번필요
		}
		...
		public int board_Edit(HttpServletRequest req) throws NamingException { //HttpServletRequest 이 인터페이스가 req 객체를 통으로 받는다 그래서 request.getParameter() 이런거 할수 있음 
			return new BoardDao().boardEdit(req); //또 dao 에게 넘김
		}
