		...
		function GetBoardList(){
			...
			$.ajax({
				...
				success : function(data){
					...
					//이방법어려우면  $('#listView').data("list",data);  이거뺴라(.data 안쓰면 더쉬워짐)
					//.data를 쓰면 key,value값을 특정태그에 숨겨둘 수 있음(저장)
					//읽어올때는 key값을 이용하여 가져올 수 있음
					//js나 localstorage 사용해도 되긴 함
