...
<%
    ...
    //getRealPath로 하면 .metadata에 있는 배포경로를 가져옴
	...
	String filename2="";
	String orifilename1="";
	String orifilename2=""; //사실 이런 String 정의도 필요없음
	...
	MultipartRequest multi = new MultipartRequest(
			...
			String file2 = (String)filenames.nextElement(); //input태그에 있는 name속성값을 뽑음
