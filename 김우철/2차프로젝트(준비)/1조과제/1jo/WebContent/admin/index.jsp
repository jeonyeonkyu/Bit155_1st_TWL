		...
		<nav class="navbar navbar-expand-sm navbar-default">
			...
			<div id="main-menu" class="main-menu collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li class="menu-item"><a href="./custom/member22.html"><i
							class="menu-icon fa fa-laptop"></i>회원관리</a></li>
					<li class="menu-item-has"><a href="./custom/product.html"><i
							class="menu-icon fa fa-table"></i>상품관리</a></li>
					<li class="menu-item-has"><a href="./custom/order.html"> <i
							class="menu-icon fa fa-th"></i>주문관리
					</a></li>
					<li class="menu-item-has"><a href="./custom/qa.html"> <i
							class="menu-icon fa fa-th"></i>문의
					</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
