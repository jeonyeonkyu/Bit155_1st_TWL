            ...
            <ul class="navbar-nav ml-auto" id="menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="../정아/introduce/index.jsp" class="dropdown-item">이정아</a>
                        <a href="../슬기/seulki.jsp" class="dropdown-item">구슬기</a>
                        <a href="../연규/introduction/index.jsp" class="dropdown-item">전연규</a>
                        <a href="../민봉/자기소개/Index/index.jsp" class="dropdown-item">장민봉</a>
