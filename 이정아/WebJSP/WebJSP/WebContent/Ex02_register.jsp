<%@ page language="java" contentType="text/html; charset=UTF-8"
 pageEncoding="UTF-8"%>
  ...
  <% 
   ...
   //서버에서는 객체를 제공 받는다.
   //아파치 톰캣이 원래부터 가지고 있던 객체 : 웹 전용 객체를 제공받는다. (request, response) : 내장객체(new 없이도 사용 가능)
   //request를 요청객체라고 한다.= 클라이언트에 대한 정보를 얻는다. (정보에는 입력한 데이터, 브라우저에 버전에 대한 정보, 클라이언트의 ip정보같은 것들이 포함),
   //response를 응답객체라고 한다. = 서버에서 받은 정보를 클라이언트에게 write하는 것
