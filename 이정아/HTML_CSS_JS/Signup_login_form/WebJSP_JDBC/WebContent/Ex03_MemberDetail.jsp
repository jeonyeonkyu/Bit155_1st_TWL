...
/*  
	...
	3.select id,pwd,name,age,gender,email from koreamember where id=? //id값을 받아서
	4.id primary key (데이터 1건(유일값) 보장)
	5.화면 출력 UI 구성
*/	
/*  
1.관리자만 접근 가능한 페이지
			...
			<td style="width: 700px">
				...
				<%
				  		...
				  		try{
				  			...
				  			//rs.next(); 추후에 데이터 1건 경우  (while 없이해도 되나, 1건이던 100건이던 그냥 while문 돌리자)
				  			while(rs.next()){
				  %>
				  			 <table style="width: 400px;height: 100px;margin-left: auto;margin-right: auto;">
				  			 	<tr>
