	...
	<script type="text/javascript">
		$(function(){
			...
			$('#container').on("click","button",function(){
				...
				// $.getJSON().. TEST 
				$.getJSON('CommentDel.jsp',data)//요청보내는 주소, parameter 값
				 .done(function(deldata){ //.done은 전역함수같은 느낌(부모객체의 메소드) 성공하면 실행해라
						 $('#container').find("table tr").not(":first").remove();
				 ...
				 .fail(function(){console.log('delete fail');}) //ajax > error (실패시)
				 .always(function(){console.log('delete always');})//ajax > complete (finally같은 느낌)
				 ;
			});
