	...
	<c:choose>
					...
					<div class="list-group">
						<c:forEach var="item" items="${hotPost}">
							<a
								...
								class="list-group-item list-group-item-action">조회${item.readcount}
								${item.title}</a>
						</c:forEach>
					</div>
				</div>
		...
		<c:otherwise>
			<div class="card my-4">
				...
				<div class="card-body">
					<a href="http://blog.naver.com/codingspecialist"
						class="list-group-item list-group-item-action"
						style="text-align: center;"> <img
						src="<%=request.getContextPath()%>/img/banner.png" width="80%"
						height="200px"></img>
					</a>
				</div>
			</div>
