...
<body>
   ...
   <%
      ...
      //http://192.168.0.169:8090/WebJSP/Ex11_WebApp_RealPath.jsp
      //      /WebJSP 실 경로(소스) :  D:\bit155\WebJSP\Labs\WebJSP
      //      /WebJSP 실 경로(배포경로) : D:\bit155\WebJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
      
      // /download/note.txt(소스) >> D:\bit155\WebJSP\Labs\WebJSP\WebContent\download\note.txt
      // /download/note.txt(소스) >> 
    //D:\bit155\WebJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download  
    
    
    //WHY??
   // 웹 서비스 하기 위해서는 WAS (서버의 특정경로에) 소스 배포
   //이클립스 WAS 내장 그래서 경로 .... 길어 ...
  ...
  // D:\bit155\WebJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
   ...
   System.out.println("SP   : " + sp);
     ...
     //  URL : http://192.168.0.169:8090/WebJSP/Ex11_WebApp_RealPath.jsp
