...
<body>
	...
	<%
		...
		if(totalboardcount % pagesize == 0){
			pagecount = totalboardcount / pagesize;  //100개 페이지를 10개씩 묶었을때 처럼 딱 떨어질때
		}else{
			pagecount = (totalboardcount / pagesize)+1; 
		}
		
		//102건 : pagesize = 5 >> pagecount = 21개페이지
		...
		<div style="padding-top: 30px; text-align: cetner">
			<table width="80%" border="1" cellspacing="0" align="center">
				<tr>
					<td colspan="5">
					<!-- 
						form 태그에는 action 값이 있어야 하는데 (전송주소(목적지주소)) >> submit()
						>> form name = "list" ... action 없다면
						>> [현재 URL 창에 있는 주소]로 날라감...
						>>board_list.jsp?ps=select 태그값으로.... 다시 호출 ....
						>>http://192.168.0.169:8090/WebServlet_5_Board_Model1_Sample1/board/board_list.jsp?cp=2&ps=10
