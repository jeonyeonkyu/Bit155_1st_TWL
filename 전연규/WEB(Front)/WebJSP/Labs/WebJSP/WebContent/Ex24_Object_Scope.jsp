...
<body>
	<!-- 
		...
		3. application(전역 객체: web.xml 자원 read, 전역자원)
		...
		scope : a.jsp(session.setAttribute "member" 변수 생성)
				b.jsp(session.getAttribute "member" read 가능)
		...
		scope : (현재 WebContect 폴더 안에 있는 모든 페이지에서 사용가능) >> java >> static 
		...
		예외적으로
		login.jsp(include, forward ) request 객체는 그 페이지에 공유된다**************************************************************************
		*****************************************************************************************************************************
		***************************************************************************************************************************
	 -->
